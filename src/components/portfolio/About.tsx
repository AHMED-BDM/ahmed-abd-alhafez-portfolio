...
import { SectionTitle } from "./SectionTitle"; // تأكد من وجود هذا المكون أو اكتبه بالأسفل
...
export const About = () => {
  ...
  const stats = [
    ...
    { n: t("about.stat3_n"), l: t("about.stat3") },
  ];
  return (
      ...
      <div className="container max-w-5xl">
        ...
        <div className="relative bg-stone gold-frame p-10 md:p-14 shadow-deep">
          ...
          <p className="relative mt-6 text-lg leading-relaxed text-foreground/85">
            {t("about.p2_a")}<span className="text-primary font-semibold">{t("about.p2_b")}</span>{t("about.p2_c")}<span className="text-primary font-semibold">{t("about.p2_d")}</span>{t("about.p2_e")}
          </p>
...
// تعريف SectionTitle إذا لم يكن موجوداً كمكون منفصل
// إذا كان لديك بالفعل في ملف منفصل، قم باستيراده وإزالة هذا الكود
