...
export const T: Dict = {
  ...
  "hero.role": { en: "Data Analyst · BI Specialist · Machine Learning Enthusiast", ar: "محلل بيانات · أخصائي ذكاء أعمال · شغوف بتعلم الآلة" },
  "hero.tagline": { en: "Data Analyst specializing in Business Intelligence and advanced analytics, complemented by a solid background in Machine Learning and AI. Backed by an MCIT (Digilians) accreditation and 1+ year of applied experience, I excel at leveraging SQL, Power BI, Tableau, and Python to drive data-driven decision-making. Successfully completed 20+ analytics projects, from HR and logistics dashboards to predictive modeling.", ar: "محلل بيانات متخصص في ذكاء الأعمال والتحليلات المتقدمة، مدعوم بخلفية صلبة في تعلم الآلة والذكاء الاصطناعي. بفضل اعتماد وزارة الاتصالات (Digilians) وخبرة تزيد عن عام، أبرع في استخدام SQL وPower BI وTableau وPython لدعم اتخاذ القرار. أنجزت أكثر من 20 مشروعاً، من لوحات تحكم الموارد البشرية إلى النمذجة التنبؤية." },
  ...
  "about.p1": { en: "Data Analyst with a strong foundation in Machine Learning and 1+ year of hands-on experience in transforming complex datasets into actionable business insights. Trained under the MCIT (Digilians initiative), mastering the modern data stack: Python, SQL, Power BI, and Tableau.", ar: "محلل بيانات بأسس قوية في تعلم الآلة وخبرة تزيد عن عام في تحويل البيانات المعقدة إلى رؤى تجارية قابلة للتنفيذ. تدرّب تحت إشراف وزارة الاتصالات (مبادرة Digilians)، مع إتقان كامل لأدوات البيانات الحديثة: Python وSQL وPower BI وTableau." },
  "about.p2_a": { en: "Delivered ", ar: "أنجز " },
  "about.p2_b": { en: "20+ projects", ar: "أكثر من 20 مشروعًا" },
  "about.p2_c": { en: " across interactive dashboards, HR analytics, logistics intelligence, and predictive modeling. Holds ", ar: " في لوحات المعلومات التفاعلية وتحليلات الموارد البشرية وذكاء الخدمات اللوجستية والنمذجة التنبؤية. يحمل " },
